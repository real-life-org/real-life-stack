...
| Orientierung, egal wofür | [`/llms.txt`](/llms.txt) | Inhaltsverzeichnis: Pakete, jede Spec-Datei, alle 58 öffentlichen Hooks mit Frage und Verhalten ohne Fähigkeit, das Handbuch als Markdown |
