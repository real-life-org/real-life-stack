 ...
 * weil Starlights Hero sein Bild nur so entgegennimmt (`hero.image.html`). Nur das Telefon, im selben
 * Maßstab wie im Handbuch, ohne Umschalter; das Skript `story-frames` belebt sie.
 */
